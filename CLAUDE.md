...
> **START HERE →** Phase 0, Session 1 (skeleton + tenancy) is done. Next action is **Session 2** in §10.1 — one vertical slice, one column type (`text`), through the full §4.3 registry interface.
